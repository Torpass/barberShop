...
// Cabecera de página
	function Header() {
		...
		$this->setXY(60, 60);
		$this->Cell(100, 8, 'Reporte del promedio de puntuacion de cada empleado', 0, 1, 'C', 0);
...
$pdf->Cell(33, 8, 'Promedio Puntuacion', 1, 1, 'C', 0);
...
$pdf->SetWidths(array(25, 20, 20, 33));
...
$Admin = new Admin();
$data = $Admin->getAvgPuntuationPerEmployee();
...
foreach($data as $avg ){
	$pdf->Row(array(
		...
		utf8_decode($avg["Promedio_Puntuacion"]),
	), 60);
}
