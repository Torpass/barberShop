...
// Cabecera de página
	function Header() {
		...
		$this->setXY(60, 60);
		$this->Cell(100, 8, 'Reporte de los servicios que los clientes mas piden', 0, 1, 'C', 0);
...
$pdf->Cell(30, 8, 'Solicitudes', 1, 1, 'C', 0);
...
$Admin = new Admin();
$data = $Admin->mostPopularServices();
...
foreach($data as $service ){
	$pdf->Row(array(
		...
		utf8_decode($service["solicitudes"]),
	), 75);
}
