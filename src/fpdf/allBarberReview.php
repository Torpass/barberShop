...
// Cabecera de página
	function Header() {
		...
		$this->setXY(60, 60);
		$this->Cell(100, 8, 'Reporte de resenas de la barberia', 0, 1, 'C', 0);
...
$pdf->Cell(20, 8, 'ID Cliente', 1, 0, 'C', 0);
$pdf->Cell(20, 8, 'Nombre', 1, 0, 'C', 0);
$pdf->Cell(20, 8, 'Apellido', 1, 0, 'C', 0);
$pdf->Cell(30, 8, 'Puntuacion', 1, 0, 'C', 0);
$pdf->Cell(45, 8, 'Descripcion', 1, 0, 'C', 0);
$pdf->Cell(33, 8, 'Status', 1, 1, 'C', 0);
...
$pdf->SetWidths(array(20, 20, 20, 30, 45, 33));
...
$Admin = new Admin();
$data = $Admin->getAllBarberReviews();
...
foreach($data as $review ){
	...
	$pdf->Row(array(
		$review["id_Cliente"], 
		utf8_decode($review["nombre_cliente"]),
		utf8_decode($review["apellido_cliente"]),
		$review["Puntuacion"],
		utf8_decode($review["Descripcion"]),
		$review["status"],
	), 20);
}
...
$pdf->Output('allBarberReviews.pdf', 'I');
