...
// Cabecera de página
	function Header() {
		...
		$this->setXY(60, 60);
		$this->Cell(100, 8, 'Reporte del porcentaje de participacion de cada empleado', 0, 1, 'C', 0);
...
$pdf->Cell(25, 8, 'ID Empleado', 1, 0, 'C', 0);
$pdf->Cell(20, 8, 'Nombre', 1, 0, 'C', 0);
$pdf->Cell(20, 8, 'Apellido', 1, 0, 'C', 0);
$pdf->Cell(35, 8, 'Citas Terminadas', 1, 0, 'C', 0);
$pdf->Cell(35, 8, 'Porcentaje Participacion', 1, 1, 'C', 0);
...
$pdf->SetWidths(array(25, 20, 20, 35, 35));
...
$Admin = new Admin();
$data = $Admin->avgEmployeeParticipation();
// --------------TERMINA BASE DE DATOS-----------------------------------------------

foreach($data as $avg ){
	$pdf->Row(array(
		$avg["Id_Empleado"], 
		utf8_decode($avg["Nombre"]), 
		utf8_decode($avg["Apellido"]), 
		utf8_decode($avg["citas_terminadas"]), 
		utf8_decode($avg["procentaje_participacion"]),
	), 37);
}
