...
// Cabecera de página
	function Header() {
		...
		$this->setXY(60, 60);
		$this->Cell(100, 8, 'Reporte de servicios y sus solicitudes', 0, 1, 'C', 0);
...
$pdf->Cell(40, 8, 'Precio', 1, 0, 'C', 0);
$pdf->Cell(35, 8, 'Cantidad solicitudes', 1, 1, 'C', 0);
...
$pdf->SetWidths(array(20, 40, 40, 35));
...
$Admin = new Admin();
$data = $Admin->generateServicesReport();
// --------------TERMINA BASE DE DATOS-----------------------------------------------

foreach($data as $service ){
	$pdf->Row(array(
		$service["id_Servicio"], 
		utf8_decode($service["nombre"]), 
		utf8_decode($service["Precio"]),
		utf8_decode($service["cantidad_solicitudes"]),
	), 40);
}
