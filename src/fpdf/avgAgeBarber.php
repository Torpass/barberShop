...
// Cabecera de página
	function Header() {
		...
		$this->setXY(60, 60);
		$this->Cell(100, 8, 'Reporte del promedio de edades de cada servicio', 0, 1, 'C', 0);
...
$pdf->Cell(40, 8, 'Nombre Servicio', 1, 0, 'C', 0);
$pdf->Cell(50, 8, 'Promedio de edad de los clientes', 1, 1, 'C', 0);
...
$Admin = new Admin();
$data = $Admin->getAvgAgeOfEachService();
// --------------TERMINA BASE DE DATOS-----------------------------------------------

foreach($data as $avg ){
	$pdf->Row(array(
		utf8_decode($avg["nombre_servicio"]), 
		$avg["promedio_edad"],
	), 20);
}
...
$pdf->Output('servicesAvgAge.pdf', 'I');
