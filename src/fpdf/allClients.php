...
// Cabecera de página
	function Header() {
		...
		$this->setXY(60, 60);
		$this->Cell(100, 8, 'Reporte de los clientes registrados', 0, 1, 'C', 0);
...
$pdf->Cell(20, 8, 'Cedula', 1, 0, 'C', 0);
$pdf->Cell(10, 8, 'Edad', 1, 0, 'C', 0);
$pdf->Cell(25, 8, 'Telefono', 1, 0, 'C', 0);
$pdf->Cell(30, 8, 'Email', 1, 1, 'C', 0);
...
$pdf->SetWidths(array(20, 20, 20, 20, 10, 25, 30));
...
foreach($data as $client ){
	...
	$pdf->Row(array(
		$client["Id_Cliente"], 
		utf8_decode($client["Nombre"]),
		utf8_decode($client["Apellido"]),
		$client["Cedula"],
		$client["edad"],
		$client["Telefono"],
		utf8_decode($client["Gmail"]),
	), 35);
}

// cell(ancho, largo, contenido,borde?, salto de linea?)

$pdf->Output('allClients.pdf', 'I');
