...
// Cabecera de página
	function Header() {
		...
		$this->setXY(60, 60);
		$this->Cell(100, 8, 'Reporte De Citas por empleado', 0, 1, 'C', 0);
...
$pdf->Cell(20, 8, 'Apellido', 1, 0, 'C', 0);
$pdf->Cell(30, 8, 'Cedula', 1, 0, 'C', 0);
$pdf->Cell(33, 8, 'Servicios en espera', 1, 0, 'C', 0);
$pdf->Cell(33, 8, 'Servicios cancelados', 1, 0, 'C', 0);
$pdf->Cell(33, 8, 'Servicios terminados', 1, 0, 'C', 0);
$pdf->Cell(25, 8, 'Total servicios	', 1, 1, 'C', 0);
...
$pdf->SetWidths(array(10, 20, 20, 30, 33, 33, 33, 25));
...
$Admin = new Admin();
$data = $Admin->reportCitasByPerEmployee();
...
foreach($data as $employee ){
	...
	$pdf->Row(array(
		...
		$employee["Apellido"],
		$employee["Cedula"],
		$employee["servicios_en_espera"],
		$employee["servicios_terminados"],
		$employee["servicios_cancelados"],
		$employee["total_servicios"],
	), 3);
}

// cell(ancho, largo, contenido,borde?, salto de linea?)

$pdf->Output('servicesPerEmployee.pdf', 'I');
